...
export interface paths {
  ...
  "/tacapi/v1/lora-info/{lora_name}": {
    /** Get Lora Info */
    get: operations["get_lora_info_tacapi_v1_lora_info__lora_name__get"];
  };
  "/tacapi/v1/lyco-info/{lyco_name}": {
    /** Get Lyco Info */
    get: operations["get_lyco_info_tacapi_v1_lyco_info__lyco_name__get"];
  };
  "/tacapi/v1/thumb-preview/{filename}": {
    /** Get Thumb Preview */
    get: operations["get_thumb_preview_tacapi_v1_thumb_preview__filename__get"];
  };
  "/tacapi/v1/thumb-preview-blob/{filename}": {
    /** Get Thumb Preview Blob */
    get: operations["get_thumb_preview_blob_tacapi_v1_thumb_preview_blob__filename__get"];
  };
  "/sdapi/v1/loras": {
    /** Get Loras */
...
export interface components {
  schemas: {
    ...
    Flags: {
       ...
       * @default /home/lisq/.sd
       */
      data_dir?: string;
      /**
       * Config
       * @description path to config which constructs model
       * @default /home/lisq/.sd/configs/v1-inference.yaml
       */
      config?: string;
      /**
       * Ckpt
       ...
       * @default /home/lisq/.sd/model.ckpt
       */
      ckpt?: string;
      /**
       * Ckpt Dir
       ...
       * @default /home/lisq/.sd/ui-config.json
       */
       ...
       * @default /home/lisq/.sd/config.json
       */
       ...
       * @default /home/lisq/.sd/styles.csv
       */
      styles_file?: string;
      /**
       * Autolaunch
    ...
    Options: {
      ...
      /**
       * Auto Vae Precision
       * @description Automaticlly revert VAE to 32-bit floats
       * @default true
       */
       ...
       * @default false
       */
      experimental_persistent_cond_cache?: unknown;
      /**
      ...
      /**
       * Extra Options
       * @description Options in main UI
       * @default []
       */
      extra_options?: unknown;
      /**
       * Extra Options Accordion
       * @description Place options in main UI into an accordion
       * @default false
       */
...
export interface operations {
  ...
  /** Get Lyco Info */
  get_lyco_info_tacapi_v1_lyco_info__lyco_name__get: {
    parameters: {
      path: {
        lyco_name: unknown;
      };
  ...
  /** Get Thumb Preview */
  get_thumb_preview_tacapi_v1_thumb_preview__filename__get: {
    parameters: {
      query: {
        type: unknown;
      };
  ...
  /** Get Thumb Preview Blob */
  get_thumb_preview_blob_tacapi_v1_thumb_preview_blob__filename__get: {
    parameters: {
      query: {
        type: unknown;
      };
